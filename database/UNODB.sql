...
--
-- Host: localhost
-- Generation Time: Oct 13, 2014 at 04:27 PM
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  `noise_rateing` int(10) NOT NULL,
  `cleanliness_rateing` int(10) NOT NULL,
  `lifestyle_rateing` int(10) NOT NULL,
  `age_rateing` int(10) NOT NULL,
  `major_rateing` int(10) NOT NULL,
  `guest_rateing` int(10) NOT NULL,
...
--
ALTER TABLE `groups`
  ADD CONSTRAINT `groups_ibfk_4` FOREIGN KEY (`room_num`) REFERENCES `rooms` (`room_num`) ON UPDATE NO ACTION,
  ADD CONSTRAINT `groups_ibfk_3` FOREIGN KEY (`build_id`) REFERENCES `building` (`build_id`);
...
--
-- Constraints for table `room_letter`
--
ALTER TABLE `room_letter`
  ADD CONSTRAINT `room_letter_ibfk_4` FOREIGN KEY (`room_num`) REFERENCES `rooms` (`room_num`),
  ADD CONSTRAINT `room_letter_ibfk_5` FOREIGN KEY (`build_id`) REFERENCES `building` (`build_id`);
