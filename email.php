...
$sql = "SELECT student_id AS 'Student ID', username AS 'Username', building_name AS 'Building Name' FROM users ORDER BY student_id";
...
<div id = "subform"> 
			...
			<form action="validate/studentVal.php" method="post">
     			<table class = "Nothing">
     				<tr>
